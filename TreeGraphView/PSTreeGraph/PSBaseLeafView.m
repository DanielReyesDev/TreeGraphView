...
//    _fillColor = [UIColor colorWithRed:1.0 green:0.5 blue:0.0 alpha:1.0];
    ...
    _borderWidth = 0;
    _showingSelected = NO;
    _fillColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1.0]; //0 0 0, 0.21
    _selectionColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1.0]; //[UIColor colorWithRed:0.85 green:0.85 blue:0.85 alpha:1.00];
}
